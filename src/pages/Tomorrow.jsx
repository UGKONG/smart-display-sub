...
export default function ({ next, item }) {
  ...
  const SKY = useMemo(() => {
    ...
    if (min?.SKY === 3 && (min?.PTY === 1 || min?.PTY === 2 || min?.PTY === 4 || min?.PTY === 5 || min?.PTY === 6) && min?.POP >= 50) minResult = sky_3_1_icon;
    if (min?.SKY === 3 && (min?.PTY === 3 || min?.PTY === 7) && min?.POP >= 50) minResult = sky_3_2_icon;
    if (min?.SKY === 4) minResult = sky_4_icon;
    if (min?.SKY === 4 && (min?.PTY === 1 || min?.PTY === 2 || min?.PTY === 4 || min?.PTY === 5 || min?.PTY === 6) && min?.POP >= 50) minResult = sky_4_1_icon;
    if (min?.SKY === 4 && (min?.PTY === 3 || min?.PTY === 7) && min?.POP >= 50) minResult = sky_4_2_icon;

    if (max?.SKY === 1) maxResult = sky_1_icon;
    if (max?.SKY === 3) maxResult = sky_3_icon;
    if (max?.SKY === 3 && (max?.PTY === 1 || max?.PTY === 2 || max?.PTY === 4 || max?.PTY === 5 || max?.PTY === 6) && max?.POP >= 50) maxResult = sky_3_1_icon;
    if (max?.SKY === 3 && (max?.PTY === 3 || max?.PTY === 7) && max?.POP >= 50) maxResult = sky_3_1_icon;
    if (max?.SKY === 4) maxResult = sky_4_icon;
    if (max?.SKY === 4 && (max?.PTY === 1 || max?.PTY === 2 || max?.PTY === 4 || max?.PTY === 5 || max?.PTY === 6) && max?.POP >= 50) maxResult = sky_4_1_icon;
    if (max?.SKY === 4 && (max?.PTY === 3 || max?.PTY === 7) && max?.POP >= 50) maxResult = sky_4_1_icon;
